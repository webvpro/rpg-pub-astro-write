...
import { b as removeBase, i as isRemotePath, p as prependForwardSlash } from './path_D4WQgygQ.mjs';
import { b as VALID_INPUT_FORMATS } from './consts_HRoi08cg.mjs';
import { A as AstroError, aq as UnknownContentCollectionError, b as createComponent, ar as RenderUndefinedEntryError, u as unescapeHTML, d as renderTemplate, as as renderUniqueStylesheet, at as renderScriptElement, au as createHeadAndContent, r as renderComponent, a as AstroUserError } from './astro/server_B3pF-2QK.mjs';
import 'kleur/colors';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Dn8BvZWr.mjs');
...
function createGetCollection({
  ...
  return async function getCollection(collection, filter) {
    ...
    if (collection in contentCollectionToEntryMap) {
      ...
      const { default: imageAssetMap } = await import('./content-assets_K9KaA68F.mjs');
      const result = [];
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_BhImh0Q1.mjs').then(n => n._);
...
async function renderEntry(entry) {
  ...
  if (entry.deferredRender) {
    try {
      const { default: contentModules } = await import('./content-modules_BLwKtvI-.mjs');
...
const starlightConfig = {"social":[{"icon":"github","label":"GitHub","href":"https://github.com/withastro/starlight"}],"tableOfContents":{"minHeadingLevel":2,"maxHeadingLevel":3},"editLink":{},"sidebar":[{"label":"Guides","translations":{},"collapsed":false,"items":[{"label":"Example Guide","translations":{},"slug":"guides/example","attrs":{}}]},{"label":"Reference","translations":{},"collapsed":false,"autogenerate":{"directory":"reference"}}],"head":[],"lastUpdated":false,"pagination":true,"favicon":{"href":"/favicon.svg","type":"image/svg+xml"},"components":{"Search":"@astrojs/starlight/components/Search.astro"},"titleDelimiter":"|","credits":false,"pagefind":{"ranking":{"pageLength":0.1,"termFrequency":0.1,"termSaturation":2,"termSimilarity":9}},"title":{"en":"Docs with Tailwind"},"isMultilingual":false,"defaultLocale":{"label":"English","lang":"en","dir":"ltr"}};

const project = {"build":{"format":"directory"},"root":"file:///C:/Users/15034/Projects/rpg-pub-astro-write/","srcDir":"file:///C:/Users/15034/Projects/rpg-pub-astro-write/src/","trailingSlash":"ignore"};
...
export { BuiltInDefaultLocale as B, stripTrailingSlash as a, stripLeadingSlash as b, stripHtmlExtension as c, ensureTrailingSlash as d, ensureHtmlExtension as e, getCollection as f, getCollectionPath as g, getCollectionPathFromRoot as h, pickLang as i, stripLeadingAndTrailingSlashes as j, ensureLeadingSlash as k, stripExtension as l, getEntry as m, project as p, renderEntry as r, starlightConfig as s, useTranslations as u };
